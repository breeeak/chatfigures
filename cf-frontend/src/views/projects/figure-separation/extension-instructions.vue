    ...
    <div class="container">
        <div class="row">
            <div class="col-12 text-center my-5">
                <p class="display-6 my-4">Chrome Extension Instruction</p>
            </div>
        </div>
        <div class="row d-inline" >
            <h1>Installation</h1>
            <p >
                Go to <a href="https://chrome.google.com/webstore/category/extensions">Chrome web store </a> and search for "ChatFigures" and choose "add to chrome" to install it.
            </p>
            <p>
                You can also directly click <a href="https://chrome.google.com/webstore/detail/chat-figures/ekoknoogfnngkknedfbodhnlkhdioiih"> Here </a> to install it.
            </p>
