...
class RandomPerspective:
    ...
    def __call__(self, labels):
        ...
        new_instances = Instances(bboxes, segments, keypoints, ocrs=instances.ocrs, bbox_format='xyxy', normalized=False)
        # Clip
...
class Format:
    ...
    def __call__(self, labels):
        ...
        if self.return_ocr:
            labels['ocrs'] = torch.from_numpy(instances.ocrs) if nl else torch.zeros((nl, self.seq_length))
