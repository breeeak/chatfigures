...
from ultralytics.nn.tasks import (ClassificationModel, DetectionModel, PoseModel, SegmentationModel, OcrModel,
...
TASK_MAP = {
    ...
    'ocr': [
        OcrModel, yolo.v8.ocr.OcrTrainer, yolo.v8.ocr.OcrValidator,
        yolo.v8.ocr.OcrPredictor],
    'segment': [
