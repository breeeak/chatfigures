...
from apps.fadmin.models import LoginInfo, User
# from apps.fadmin.utils.jwt_util import OpAuthJwtAuthentication
...
def save_login_log(request, msg='', status=True, session_id=''):
    """
    保存登录信息
    """
    instance = LoginInfo()
    ...
    instance.ipaddr = get_request_ip(request)   # TODO 分析IP地址
