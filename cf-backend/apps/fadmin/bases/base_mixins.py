# -*- coding: utf-8 -*-
# @Time    : 2022/10/16 21:01
# @Author  : Marshall
# @FileName: base_mixins.py
...
from apps.fadmin.utils.request_util import get_verbose_name
from apps.fadmin.utils.response_util import SuccessResponse
from apps.fadmin.utils.excel_util import excel_to_data, export_excel_save_model


class ListModelMixin(mixins.ListModelMixin):
    """
    继承、增强DRF的ListModelMixin, 标准化其返回值
    """
...
class RetrieveModelMixin(mixins.RetrieveModelMixin):
    """
    继承、增强DRF的RetrieveModelMixin, 标准化其返回值
    """
...
class UpdateModelMixin(mixins.UpdateModelMixin):
    """
    继承、增强DRF的UpdateModelMixin, 标准化其返回值
    """
...
class ImportSerializerMixin:
    ...
    def importTemplate(self, request: Request, *args, **kwargs):
        ...
        for ele in data:
            ...
            serializer.is_valid(raise_exception=True)
            serializer.save()
        return SuccessResponse(msg=f"导入成功！", status=status.HTTP_201_CREATED)
