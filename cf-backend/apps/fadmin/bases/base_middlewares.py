# -*- coding: utf-8 -*-
# @Time    : 2022/10/18 13:41
# @Author  : Marshall
# @FileName: base_middlewares.py
...
from apps.fadmin.utils.response_util import ErrorJsonResponse
from apps.fadmin.models import Menu
from apps.fadmin.models import OperationLog
from apps.fadmin.utils.request_util import get_request_ip, get_request_data, get_request_path, get_browser, get_os, \
