...
from apps.fadmin.utils.jsonpath_util import get_jsonpath, filter_json, search_json
from apps.fadmin.utils.sort_util import sortList
from apps.fadmin.utils.pagination_util import JsonPagination

from apps.fadmin.bases.base_views import CustomAPIView
import apps.fadmin.bases.base_mixins as mixins
"""
增加了一个JsonListView  但是没有用
同drf中genericAPIview
"""
...
class GenericAPIView(CustomAPIView):
    ...
    完全同drf中genericAPIview只不过继承了自己增强的APIview
    """
