...
class Role(CoreModel):
    ...
    role_name = CharField(max_length=64, verbose_name="角色名称")
    role_key = CharField(max_length=64, verbose_name="权限字符")
    role_sort = IntegerField(verbose_name="角色顺序")
    status = CharField(max_length=8, verbose_name="角色状态")
    admin = BooleanField(default=False, verbose_name="是否为admin")
    data_scope = CharField(max_length=8, default='1', choices=DATASCOPE_CHOICES, verbose_name="权限范围", )
