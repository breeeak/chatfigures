...
class Menu(CoreModel):
    ...
    parent_id = ForeignKey(to='Menu', on_delete=CASCADE, verbose_name="上级菜单", null=True, blank=True,
                           db_constraint=False)
    menu_type = CharField(max_length=8, choices=MENU_TYPE_CHOICES, default="1", verbose_name="菜单类型")
    ...
    is_frame = CharField(max_length=8, verbose_name="是否外链")
    ...
    interface_method = CharField(max_length=16, default='GET', choices=MENU_TYPE_CHOICES, verbose_name="接口请求方式")
    ...
    is_cache = CharField(max_length=8, verbose_name="是否缓存")
