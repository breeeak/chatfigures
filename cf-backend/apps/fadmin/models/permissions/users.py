...
from django.db.models import IntegerField, ForeignKey, CharField, TextField, ManyToManyField, CASCADE, SmallIntegerField
...
class User(AbstractUser, CoreModel):
    ...
    email = CharField(max_length=255, unique=True, verbose_name="邮箱", null=True, blank=True)
    ...
    gender = CharField(max_length=8, verbose_name="性别", null=True, blank=True)  # {'男': '0', '女': '1', '未知': '2'}
    user_type = SmallIntegerField(choices=USER_TYPE_CHOICES, default=0, verbose_name="用户类型")
    ...
    class Meta:
        abstract = settings.AUTH_USER_MODEL != 'fadmin.User'
        verbose_name = '用户管理'
